...
hero_score_dict = {"蜀步刘备":5,"汉弓张机":5,"吴弓吕蒙":5,"蜀骑关羽":5,"魏骑曹操":5,"蜀骑马岱":5,"吴步陆抗":2,"魏骑张辽":2,"吴弓孙权":1,"蜀步关银屏":1,"蜀步魏延":1,
                        "群弓吕布":5,"群骑马超":5,"蜀弓诸葛亮":5,"蜀骑徐庶":2,"吴步陆逊":1,"吴弓周瑜":1,"蜀步赵云":1}
...
if __name__ == '__main__':
    ...
    for i in range(0,20):
        ...
        print(url, "价格: ", Account_List[i].price, "综合分: ", Account_List[i].score, "关键武将数: ", Account_List[i].key_hero_num, "前三对红度和: ", sum(Account_List[i].team_rank[:3]) - 9)
